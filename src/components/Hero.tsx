      ...
      >
        ...
        >
          <div className="flex items-center justify-between">
            ...
            >
              <img src={iconImg} alt="PASH Logo" className="h-10 w-10 object-cover rounded-full mr-3" />
              <span className="font-montserrat text-white text-xl tracking-wider hidden sm:block">pash</span>
            </motion.div>
      ...
      >
        <div className="max-w-2xl">
          <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-black leading-tight text-white">
            ...
            <span className="block">SCIENCE HUB</span>
          </h1>
        </div>
      </motion.div>
