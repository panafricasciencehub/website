  ...
  const services = [
    {
      ...
      description: "Free access to full university course materials—including lecture videos, notes, assignments, and exams directly from MIT.",
      color: 'accent-emerald',
      rotation: 'rotate-2',
      image: 'https://discovery-lms.eduvence.com/public/images/organization-covers/mit-org-detail-square-cover.png',
    ...
    },
    {
      ...
      color: 'accent-blue',
      rotation: '-rotate-1',
      image: 'https://1000logos.net/wp-content/uploads/2018/02/Stanford-University-Logo.jpg',
      link: 'https://www.classcentral.com/university/stanford'
    },
    {
      id: 'yale',
      title: "Yale University Courses",
      description: "Develop critical thinking with free, open access to selected undergraduate lectures and interdisciplinary learning.",
      color: 'accent-emerald',
      rotation: '-rotate-2',
      image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRCnoAy9l4AEDqsA7kt3Um9xdT3AwQ418xMVQ&s',
    ...
    },
    {
      ...
      color: 'accent-blue',
      rotation: 'rotate-3',
      image: 'https://academicearth.org/wp-content/uploads/2013/05/schools_uc-berkeley.png',
    ...
    },
    {
      ...
      color: 'accent-blue',
      rotation: 'rotate-3',
      image: 'https://i.pinimg.com/474x/e4/29/a7/e429a779f3d805f4bd597cbc95b628aa.jpg',
    ...
    <section id="services" className="relative py-20" style={{
      ...
      <div className="container mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className={`text-5xl sm:text-6xl lg:text-7xl font-black leading-tight mb-6 text-amber-100 transform transition-all duration-1000 delay-200 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-12 opacity-0'
            }`}>
            Pash learning hub
          </h2>

          <p className={`text-xl text-amber-200/90 leading-relaxed max-w-3xl mx-auto transform transition-all duration-1000 delay-400 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'
            }`}>
            OPEN LEARNING with WORLD CLASS UNIVERSITIES
          </p>
        </div>

        {/* Photo Lab Clotheslines */}
        <div className={`w-full transform transition-all duration-1000 delay-600 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-12 opacity-0'
          ...
          <div className="relative mb-24" style={{ overflow: 'visible' }}>
            ...
            <div className="flex flex-wrap justify-center gap-4 sm:gap-8 lg:gap-16 pt-20 max-w-7xl mx-auto px-4">
              {services.slice(0, 3).map((service, index) => (
                <div
                  key={service.id}
                  className={`transform transition-all duration-700 ${hoveredPhoto === service.id ? 'scale-105 -translate-y-2' : 'scale-100'
                    ...
                    <div className="h-48 mb-6 rounded-sm relative group">
                      {service.link ? (
                        <a href={service.link} target="_blank" rel="noopener noreferrer" className="block w-full h-full relative cursor-pointer">
                          ...
                          />
                          <div className="absolute inset-0 bg-black/40 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-sm z-10">
                            <span className="text-white font-bold bg-white/20 px-4 py-2 rounded-full backdrop-blur-sm border border-white/40 shadow-lg">Click Here</span>
                          </div>
                        </a>
                      ) : (
                        <ImageWithFallback
          ...
          <div className="mt-16 text-center">
            <p className="text-sm text-amber-200/70 leading-relaxed max-w-2xl mx-auto">
              Each insight is rigorously developed within our scientific community, ensuring every publication drives African innovation forward with precision and impact.
            </p>
          </div>
        </div>
      </div>
