    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center space-y-8 max-w-4xl mx-auto px-4">
          <h1 className="font-montserrat text-6xl md:text-8xl text-shadow-strong">
            BAGEL FAT
          </h1>
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <h2 className="text-4xl font-bold font-montserrat">Типографика</h2>
          
          <div className="space-y-6">
            <h1 className="font-montserrat text-shadow-medium">Заголовок H1 с Bagel Fat</h1>
